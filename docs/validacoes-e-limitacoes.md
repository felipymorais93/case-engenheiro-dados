...
- Checagem de produtos referenciados em itens sem cadastro correspondente, identificou-se o `P8888`.
...
- `net_amount` não reconciliado em 12 pedidos e `total_item` não reconciliado em 47 itens. Ambos sinalizados via flag, não corrigidos automaticamente, porque a causa raiz não pode ser inferida só com os dados disponíveis.
